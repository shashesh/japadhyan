...
**JapaDhyan** (जपध्यान — _japa_, repeating the Name, and _dhyan_, meditation) is a devotee-first app for **naam japam** (name chanting) and mantra sadhana, for web, Android and iOS.
...
- [Open questions](docs/product/open-questions.md) — languages, pricing, content sourcing
