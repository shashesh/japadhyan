...
Steps 1 to 4 are `tools/content-build`. Signing is a separate script, and publishing and media checksums wait for the [hosting choice](../product/open-questions.md#content-hosting).
